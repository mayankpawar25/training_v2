...
export class UxUtils {
            ...
            <div class="container">
                <div id="root" class="">
                    ...
                    <div class="form-group mb0">
                        <label class="cover-image-label font-12 semi-bold mb--8 app-black-color ">${coverImageKey}</label>
                        ...
                        <div class="relative" tabindex="0" role="image">
                            ...
                            <div class="training-updated-img quiz-updated-img max-min-220 card-bg card-border cursor-pointer updated-img bdr-none bg-none fixed-ar fixed-ar-16-9 relative" style="display:none">
                                <img src="" id="training-img-preview" class=" training-updated-img quiz-updated-img card-bg card-border cursor-pointer heightfit" >
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div id="root" class="">
                    <div class="training-card-section">
                        <div class="quiz-updated-img max-min-220 bdr-none bg-none cover-img cursor-pointer mb--16" style="display:none;">
                            <img src="" id="training-title-image" style="" class="quiz-updated-img card-bg card-border">
                    ...
                    <div class="col-12 content-menu">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li class="cursor-pointer" tabindex="0" role="button" data-id="add-text"><a id="add-text">${Constants.getTextIcon()} <span class="text-label">Text</span></a></li>
                                <li class="cursor-pointer" tabindex="0" role="button" data-id="add-photo"><a id="add-photo">${Constants.getImageIcon()} <span class="photo-label">Image</span></a></li>
                                <li class="cursor-pointer" tabindex="0" role="button" data-id="add-document"><a id="add-document">${Constants.getDocumentIcon()} <span class="document-label">Document</span></a></li>
                                <li class="cursor-pointer" tabindex="0" role="button" data-id="add-video"><a id="add-video">${Constants.getVideoIcon()} <span class="video-label">Video</span></a></li>
                                <li class="cursor-pointer" tabindex="0" role="button" data-id="add-questions"><a id="add-questions">${Constants.getQuestionIcon()} <span class="quiz-label">Quiz</span></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        return `<div class="footer question-footer" >
            <div class="footer-padd bt">
                <div class="container ">
                    <div class="row">
                        <div class="col-9 d-table">
                            <a class=" cursor-pointer" id="back-question">
                    ...
                    <div class="">
                        ...
                        <div class="form-group mb--16">
                            ...
                            <div class="relative">
                                ...
                                <div class="video-box card card-bg card-border max-min-220 upvj"  tabindex="0" role="image">
                    ...
                    <div class="">
                        ...
                        <div class="form-group mb--16">
                            ...
                            <div class="loader-cover show-document-loader" style="display:none;">
                                ...
                                <div class="doc-box card card-bg card-border max-min-220 upvj" tabindex="0" role="doc">
    ...
    static getAddTextContainer(textData) {
        return `<div class="card-box card-bg card-border training-card-section section-div text-section-div">
            ...
            <p class="text-break mb0 mt--16 text-description-preview text-justify font-12">${textData}</p>
                    ...
                    <div class="col-12">
                        <div class="hover-btn">
                            <div class="d-table mb--4 pre-none">
                                ...
                                <label class="float-right result-status" id="status-1">
                                    <button type="button" class="close remove-text" data-dismiss="alert">
                                        <span aria-hidden="true" class="input-group-text remove-option-q12 input-tpt cursor-pointer">
                                            ${Constants.getTrashIcon()}
                                        </span>
                                        <span class="sr-only">Close</span>
                                    </button>
    ...
    static getAddVideoSection(textNumber, textData) {
            ...
            <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <p class="mt--16 video-description-preview text-justify text-break">${textData}</p>
                    </div>
                </div>
            </div>
        ...
        return `<div class="card-box card-bg card-border training-card-section section-div video-section-div" data-id="text-section-${counter}" id="section-${counter}">
                <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <p class="mt--16 video-description-preview text-justify text-break ${loaderClass}" style="${loaderCss}">${videoDescription}</p>
                            ${loaderButton}
                        </div>
                    </div>
                </div>
    ...
    static getAddDownloadSection(textNumber, textData) {
        return `<div class="card-box card-bg card-border training-card-section section-div document-section-div">
            ...
            <div class="row">
                <div class="col-12">
                    <p class="mt--16 document-description-preview text-break text-justify">${textData}</p>
                </div>
    ...
    static getEditDownloadSection(counter, documentTitle, documentDescription, documentAtachment, fileTypeIcon = '', loaderClass, loaderCss, loaderButton) {
        return `<div class="card-box card-bg card-border training-card-section section-div document-section-div" data-id="text-section-${counter}" id="section-${counter}">
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <p class="mt--16 document-description-preview text-break text-justify ${loaderClass}" style="${loaderCss}">${documentDescription}</p>
                    ${loaderButton}
                </div>
                <div class="col-12" style="display:none;">
                    <div class="img-thumbnail">
        ...
        return `<div class="footer">
            <div class="footer-padd bt">
                <div class="container ">
                    <div class="row">
                        <div class="col-9">
                            <a class="cursor-pointer back1" userid-data="${userId}" id="hide2" tabindex="0" role="button">
